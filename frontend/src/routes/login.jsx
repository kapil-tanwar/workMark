...
import { Briefcase, UserRound, Lock, ArrowRight, Loader2, Eye, EyeOff } from "lucide-react";
...
function LoginPage() {
  ...
  return (
    <AuthSplitLayout aside={<LoginAside />}>
      <Link to="/" className="flex items-center gap-2 mb-2 hover:opacity-90 transition-opacity w-fit">
